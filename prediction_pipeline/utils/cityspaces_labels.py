...
drivable_road_colors = np.array([road])


# Non-drivable road
side_walk = np.array([244, 35,232], dtype='uint8')
parking = np.array([250,170,160], dtype='uint8')
rail_track = np.array([230,150,140], dtype='uint8')

non_drivable_road_colors = np.array([side_walk, parking, rail_track])


# Crosswalk

crosswalk_colors = np.array([])
...
human_colors = np.array([person, rider])
...
licence_plate = np.array([0, 0, 142], dtype='uint8')

vehicle_colors = np.array([bicycle, bus, car, caravan, motorcycle, on_rails, other_vehicle, trailer, truck])

cityscapes_eight_classes = np.array([drivable_road_colors, non_drivable_road_colors, crosswalk_colors, lane_marking_colors, human_colors, traffic_light_colors, vehicle_colors])
